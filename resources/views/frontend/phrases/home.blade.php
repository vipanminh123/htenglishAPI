...
@section('body_class', 'phrase-page show-sidebar')
            ...
            <form method="POST" action="/phrases/add" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-sm-offset-4 text-right">
                        <a href="/phrases/storage"><button class="btn btn-success dim" type="button">Go To storage <i class="fa fa-arrow-right"></i></button></a>
                    </div>
                </div>
            </form>
        </div>
